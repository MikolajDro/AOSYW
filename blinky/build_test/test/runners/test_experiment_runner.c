...
extern void test_is_data_valid_should_zero_whenEverythingIsValid(void);
...
int main(void)
{
  ...
  run_test(test_is_data_valid_should_zero_whenEverythingIsValid, "test_is_data_valid_should_zero_whenEverythingIsValid", 48);
